 ...
 * @property {String} [src] The source directory to inspect
 ...
 * @property {Boolean} [noempty] Consider empty lines from line count
 * @property {String} [eslintrc] Specify a eslintrc file for ESLint linting
 ...
 * @property {String} outputDir The directory to store the output report
 */
